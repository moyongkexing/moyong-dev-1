...
const PORTFOLIO_ITEMS = [
  ...
  },
  {
    ...
    text: [
      ...
      "HTML/CSSから始めて、GitやMVC、RDB、セッション、ソフトウェアテストなど、web開発における基本的な概念に一通り触れることができました。AWSデプロイとDocker運用にも挑戦したのですが、結局挫折しました。ネットに転がっている指南記事や書店の本を読み漁りながら試行錯誤していましたが、今振り返れば公式ドキュメントを読み解けるだけの基礎的な知識が必要でした。webを支える技術がどれほど広範にわたるものかを痛感したので、それも良い経験になりました。"
    ]
  }
];
const Works: VFC = () => {
