...
const PORTFOLIO_ITEMS = [
  {
    ...
    text: [
      "オンライン学習プラットフォーム RecursionCS での課題作品で、その中で最も苦労したプロジェクトです。ユーザーはまず賭け金を調節して、それ以降は手持ちのカードの合計値に応じてアクションを選択します。ゲーム仕様は教材内で提示されたものを参考にしていますが、実装は完全自力です。",
  ...
  },
  {
    ...
    text: [
      "2つ目の自己紹介用ホームページです。",
      "Next.jsでのSSG、ISRに手を出してみたくて作り始めましたがRecursionCSというサービスに出会い、ただのポートフォリオ置き場になりました。",
      "現時点のこだわりポイントはこのページの技術タグにenumsを使っていることで、Qiitaにも投稿しました。データをmapメソッドで展開することでJSXをすっきりと(?)書くことにもこだわっています。",
    ],
  },
  {
